...
const AnimeDescription: React.FC<AnimeDescriptionProps> = memo(
    ({
        detail,
        className,
        collectLoading,
        ...
        const { run: handleCollected } = useDebounceFn(() => onCollected(), {
            wait: 200
        });
                ...
                <div className={cn('flex items-center text-xs mt-1.5 gap-3')}>
                    ...
                    {!isRating ? (
                        ...
                        >
                            <div
                                className={cn(
                                    'text-orange-400 md:cursor-pointer'
                                )}
                                title="动漫评分"
                            >
                                {averageRating
...
AnimeDescription.displayName = 'AnimeDescription';
