        ...
        <div className={cn('flex', className)}>
            ...
            <div className={cn('flex flex-col justify-between flex-1')}>
                ...
                <div className={cn('flex flex-col gap-2')}>
                    <Skeleton className={cn('relative w-12 h-3 rounded-sm')} />
                    <Skeleton className={cn('relative w-24 h-3 rounded-sm')} />
                </div>
            </div>
        </div>
    );
...
const VideoCard: React.FC<VideoCardProps> = ({
    ...
    return (
        ...
        >
            ...
            <div className={cn('flex flex-col justify-between flex-1')}>
                <div
                    className={cn('w-fit line-clamp-2 text-sm text-foreground')}
                >
                    {title}
                </div>
                <div
